...
def parseCommandline():
    ...
    parser = OptionParser(usage="Usage: pymake.py [ -c Compiler ] [ -d Source Directory ] [ -f \"Flags\" ] [ -i Install Directory ] [ -o Output File ]", version="PyMake Version 0.1.6")
