...
def parseCommandline():
    ...
    parser = OptionParser(usage="Usage: pymake.py [ -c Compiler ] [ -d Source Directory ] [ -f \"Flags\" ] [ -i Install Directory ] [ -o Output File ]", version="PyMake Version 0.2")
...
def compilerName(fileType):
    if fileType is "c" or fileType is "s" or fileType is "asm":
        return "gcc"
    elif fileType is "cpp" or fileType is "cxx" or fileType is "cp" or fileType is "cc":
        return "g++"
    elif fileType is "f" or fileType is "F" or fileType is "FOR":
        return "gfortran"
    elif fileType is "go":
        return "go build"
    else:
...
def flagsForCompiler(compilerName):
    ...
    if compilerName is "g++":
        compilerVarName = "CXX"
        compilerFlagsName = "CXXFLAGS"
    elif compilerName is "gfortran":
        compilerVarName = "FF"
        compilerFlagsName = "FFLAGS"
    elif compilerName is "go build":
        compilerVarName = "GC"
